...
<div style={{ marginTop: '-4rem' }}>
  ...
  <div className="blog-post">
    <h2 className="post-title">
      Model2Vec model size improvements
    </h2>
    <p className="post-date">October 5, 2025</p>
    ...
    <a
      className="read-more"
      href="/blog/2025-10-05-size-blogpost"
    >
      READ MORE
    </a>
  </div>
