...
authors:
  - minish
excerpt: "This blogpost describes the Tokenlearn method, which is a method to pre‐train Model2Vec models."
---
...
![SpeedvsAccuracy](/images/blog/post_tokenlearn/speed_vs_mteb_score_v2.png)
