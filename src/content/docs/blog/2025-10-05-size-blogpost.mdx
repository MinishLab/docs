...
authors:
  - minish
excerpt: "In this blogpost, we showcase the various size reduction techniques we implemented in Model2Vec, and how they can be combined to create tiny models (~6mb) with minimal performance loss."
---
