---
title: Results
description: The results of Model2Vec on MTEB and training results
sidebar:
  icon: chart-bar
---

The results of Model2Vec are presented in the following sections:
- [MTEB Results](#mteb-results-english)
- [MMTEB Results](#mmteb-results-multilingual)
...
| ![Description](/images/speed_vs_mteb_plot.png) |
|:--:|
...
| ![Description](/images/training_speed_vs_score.png) |
|:--:|
