...
export const homepagePackages: HomepagePackageDefinition[] = [
  ...
  },
  {
    ...
    docsHref: '/packages/semble/introduction/',
    logoSrc: '/images/logos/semble_logo.webp',
    logoAlt: 'Semble',
    githubHref: 'https://github.com/minishlab/semble',
    githubRepo: 'minishlab/semble',
    downloadsHref: 'https://pypi.org/project/semble/',
    downloadSource: { type: 'pypi', name: 'semble' },
    fallbackStars: 50,
    fallbackDownloads: 63000,
  },
  {
    name: 'SemHash',
