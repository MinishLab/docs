...
description: "Model2Vec integrations with other libraries"
icon: "list"
---
...
Model2Vec is the default model for semantic chunking in [Chonkie](https://github.com/chonkie-inc/chonkie). To use Model2Vec for semantic chunking in Chonkie, simply install Chonkie with `pip install chonkie[semantic]` and use one of the `potion` models in the `SemanticChunker` class. The following code snippet shows how to use Model2Vec in Chonkie:

```python
from chonkie import SDPMChunker

# Create some example text to chunk
text = "It's dangerous to go alone! Take this sword."
...
Model2Vec can be used [as an embedding model in BERTopic](https://maartengr.github.io/BERTopic/getting_started/embeddings/embeddings.html#model2vec).
The following snippet shows how to use Model2Vec in BERTopic:
...
Model2Vec can be used [as an embedding model in KeyBert](https://maartengr.github.io/KeyBERT/guides/embeddings.html#model2vec).
The following snippet shows how to use Model2Vec in KeyBert:
...
The Model2Vec Weaviate documentation can be found [here](https://docs.weaviate.io/weaviate/model-providers/model2vec).

## Milvus

The Model2Vec Milvus documentation can be found [here](https://milvus.io/docs/embed-with-model2vec.md)
